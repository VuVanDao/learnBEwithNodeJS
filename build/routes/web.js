...
var initWebRoutes = function initWebRoutes(app) {
  ...
  route.get("/api/get-extra-info-doctor-by-id", doctorController.getExtraInfoDoctorById);
  ...
  route.post("/api/create-new-specialty", specialtyController.createNewSpecialty);
