...
var doctorservice = require("../services/doctorservice.js");
...
var postInforDoctors = /*#__PURE__*/ (function () {
          ...
          while (1)
            switch ((_context3.prev = _context3.next)) {
              case 0:
                _context3.prev = 0;
                _context3.next = 3;
                return doctorservice.saveDetailInforDoctor(req.body);
              case 3:
  ...
  return function postInforDoctors(_x5, _x6) {
...
const bulkCrateSchedule = /*#__PURE__*/ (function () {
  ...
  return function bulkCrateSchedule(_x9, _x10) {
    return _ref5.apply(this, arguments);
  };
})();
const getScheduleByDate = /*#__PURE__*/ (function () {
          ...
          while (1)
            switch ((_context6.prev = _context6.next)) {
              case 0:
                _context6.prev = 0;
                _context6.next = 3;
                return doctorservice.getScheduleByDate(
                  req.query.doctorId,
                  req.query.date
                );
              case 3:
          ...
          while (1)
            switch ((_context7.prev = _context7.next)) {
              case 0:
                _context7.prev = 0;
                _context7.next = 3;
                return doctorservice.getExtraInfoDoctorById(req.query.doctorId);
              case 3:
          ...
          while (1)
            switch ((_context8.prev = _context8.next)) {
              case 0:
                _context8.prev = 0;
                _context8.next = 3;
                return doctorservice.getProfileDoctorById(req.query.doctorId);
              case 3:
          ...
          while (1)
            switch ((_context9.prev = _context9.next)) {
              case 0:
                _context9.prev = 0;
                _context9.next = 3;
                return doctorservice.getListPatientForDoctor(
                  req.query.doctorId,
                  req.query.date
                );
              case 3:
