...
var sendAttachment = require("./emailService.js");
...
var checkRequiredFields = function checkRequiredFields(inputData) {
  var arr = ["doctorId", "action", "selectedPrice", "selectedPayment", "selectedProvince", "nameClinic", "addressClinic", "note", "specialty"];
  var valid = true;
  var element = "";
    ...
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 22:
            _context3.next = 24;
            return db.Doctor_infor.findOne({
              where: {
                doctorId: inputData.doctorId
              },
              raw: false
    ...
    var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          ...
          case 12:
            _context10.next = 14;
            return emailService.sendAttachment(data);
          case 14:
            resolve({
              errCode: 0,
              errMessage: "ok"
