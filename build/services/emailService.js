      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return transporter.sendMail({
            from: '"Van Dao 👻" <dao28905@gmail.email>',
            // sender address
...
var getBodyHTMLEmail = function getBodyHTMLEmail(dataSend) {
  ...
  if (dataSend.language == "vi") {
    result = " <h3>Xin ch\xE0o ".concat(dataSend.patientName, "!</h3>\n    <h4>\u0110o\xE1n xem ai l\xE0 ng\u01B0\u1EDDi \u0111\xE3 \u0111\u1EB7t l\u1ECBch th\xE0nh c\xF4ng n\xE0ooo </h4>\n    <p>Th\xF4ng tin \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh</p>\n    <div><b>Th\xF2i gian ").concat(dataSend.time, "</b></div> , \n    <div><b>B\xE1c s\u0129 ").concat(dataSend.doctorName, "</b></div>\n    <p>N\u1EBFu th\xF4ng tin tr\xEAn l\xE0 chu\u1EA9n , plzz \u1EA5n x\xE1c nh\u1EADn v\xE0 ho\xE0n t\u1EA5t th\u1EE7 t\u1EE5c</p>\n    <div><a href=").concat(dataSend.redirectLink, " target='_blank'>X\xE1c nh\u1EADn</a></div>\n    <div>C\u1EA3m \u01A1nnnnnn</div> ");
  }
  if (dataSend.language == "en") {
    result = " <h3>Hello ".concat(dataSend.patientName, "!</h3>\n    <h4>Guess who successfully booked the appointment </h4>\n    <p>Information on scheduling medical examinations</p>\n    <div><b>Time: ").concat(dataSend.time, "</b></div> , \n    <div><b>Doctor ").concat(dataSend.doctorName, "</b></div>\n    <p>If the above information is correct, please click confirm and complete the procedure</p>\n    <div><a href=").concat(dataSend.redirectLink, " target='_blank'>Confirm</a></div>\n    <div>Thank</div> ");
  }
  return result;
};
...
var getBodyHTMLEmailRemedy = function getBodyHTMLEmailRemedy(dataSend) {
  var result = "";
  if (dataSend.language == "vi") {
    result = " <h3>Xin ch\xE0o ".concat(dataSend.patientName, "!</h3>\n    <h4>\u0110o\xE1n xem ai l\xE0 ng\u01B0\u1EDDi \u0111\xE3 \u0111\u01B0\u1EE3c x\xE1c nh\u1EADn \u0111\u1EB7t l\u1ECBch th\xE0nh c\xF4ng n\xE0ooo </h4>\n    <p>Th\xF4ng tin \u0111\u1EB7t l\u1ECBch kh\xE1m b\u1EC7nh</p>\n    <p>Th\xF4ng tin \u0111\u01A1n thu\u1ED1c/ ho\xE1 \u0111\u01A1n \u0111\u01B0\u1EE3c g\u1EEDi trong file \u0111\xEDnh k\xE8m</p>\n    <div>C\u1EA3m \u01A1nnnnnn</div> ");
  }
  if (dataSend.language == "en") {
    result = " <h3>Hello ".concat(dataSend.patientName, "!</h3>\n    <h4>Guess who successfully booked the appointment </h4>\n    <p>Information on scheduling medical examinations</p>\n   <p>????????</p>\n    <div>Thank</div> ");
  }
